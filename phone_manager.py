...
class PhoneAssignments():
    ...
    def add_employee(self, employee):
        ...
        for nEmployee in self.employees:
            if employee.id == nEmployee.id:
                raise PhoneError
    ...
    def add_phone(self, phone):
        ...
        for nPhone in self.phones:
            if phone.id == nPhone.id:
                raise PhoneError
    ...
    def assign(self, phone_id, employee):
        ...
        ##raising exception to this phone already being assigned
        ...
        for phone in self.phones:
            if phone.id == phone_id and phone.employee_id != None:
                raise PhoneError
            ## returning if employee already has the phone
        for phone in self.phones:
            if phone.employee_id == employee.id:
                raise PhoneError
            ##raising exception for employee already having a phone
        for phone in self.phones:
